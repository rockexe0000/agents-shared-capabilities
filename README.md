...
> 設計與 WHY(ADR)、實作出處(handoff)集中在 [`docs/design-notes.md`](docs/design-notes.md)。
...
- **安裝(pod,規劃中)**:agents-infra build-time 讀同一 manifest 烤進 image。實作進度見 [`docs/design-notes.md`](docs/design-notes.md) 的 handoff 出處。
